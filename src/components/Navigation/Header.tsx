...
export default function Header() {
  ...
  return (
    <header className="flex flex-wrap justify-between items-center px-4 py-4 bg-white border-b border-gray-200 relative z-50">
      ...
      >
        <img src="/images/Logo.svg" alt="Logo Serra Energy" className="w-[60px] h-[60px]" />
        <h1 className="text-[#2D875A] text-lg sm:text-2xl lg:text-5xl font-bold">1º SERRA ENERGY</h1>
      </button>
